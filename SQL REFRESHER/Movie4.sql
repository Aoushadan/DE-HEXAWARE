...
DELETE FROM Seat WHERE screen_id = 5;

DELETE FROM Screen WHERE screen_id = 6;

DELETE FROM Seat WHERE screen_id = 7;

DELETE FROM MovieCast WHERE person_name = 'Aoushadan';
